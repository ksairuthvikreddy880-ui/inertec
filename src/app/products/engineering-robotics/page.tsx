      ...
      sections={[
        {
          ...
          content: "We integrate collaborative and industrial robots into custom glovebox enclosures for automated sample handling, electrode coating, cell assembly, and material transfer. All robotic systems are adapted for inert atmosphere operation with sealed cable feedthroughs and inert-compatible materials.",
        },
        {
          title: "Custom Engineering Solutions",
          content: "Our in-house engineering team designs bespoke automation solutions including motorized stages, conveyor systems, automated antechambers, and process-specific tooling. SolidWorks-based design with FEA analysis ensures structural integrity and process reliability.",
        },
      ]}
      features={[
        "Robotic arms adapted for inert atmosphere",
        "Sealed cable and pneumatic feedthroughs",
        "Motorized XYZ stages and conveyors",
        "Automated antechamber loading systems",
        "PLC integration with existing process control",
        "Custom tooling and end-effectors",
        "Remote monitoring and control capability",
        "Full CE marking and safety compliance",
      ]}
