...
export default function AdditiveManufacturingPage() {
  return (
    <PageLayout
      ...
      sections={[
        {
          title: "Reactive Metal Powder Handling",
          content: "Titanium, aluminum, and other reactive metal powders must be handled under inert atmosphere to prevent oxidation and moisture absorption. Our powder handling gloveboxes include sieving, weighing, and storage capabilities under continuous inert gas purge.",
        },
        {
          title: "Build Chamber Integration",
          content: "Custom inert atmosphere enclosures can be integrated with existing SLS/SLM build chambers or designed as standalone powder preparation and post-processing stations. Oxygen levels are maintained below 100 ppm for reactive metal processing.",
        },
      ]}
      features={[
        "O₂ <100 ppm for reactive metal processing",
        "Powder sieving and weighing integration",
        "Anti-static design for powder safety",
        "Large-format enclosures available",
        "Continuous inert gas purge",
        "Explosion-proof options for reactive metals",
      ]}
