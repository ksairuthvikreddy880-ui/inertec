...
export default function MaterialPurificationPage() {
  return (
    <PageLayout
      ...
      sections={[
        {
          title: "Pharmaceutical API Purification",
          content: "Active pharmaceutical ingredients that are moisture-sensitive or oxygen-reactive require inert atmosphere processing during purification steps. Our GMP-compatible gloveboxes support recrystallization, filtration, and drying under controlled conditions with full documentation.",
        },
        {
          title: "Chemical & Materials Purification",
          content: "Distillation, sublimation, and zone refining of reactive materials can be performed inside Inertec gloveboxes with integrated heating and vacuum systems. Custom configurations support specific process requirements.",
        },
      ]}
      features={[
        "GMP-compatible construction available",
        "Integrated vacuum and heating systems",
        "Distillation and sublimation capability",
        "Filtration under inert atmosphere",
        "Full process documentation support",
        "Cleanable and sterilizable surfaces",
      ]}
